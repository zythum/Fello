...
| 技术 | 版本 | 说明 |
| --- | --- | --- |
| @agentclientprotocol/sdk | ^0.21.0 | ACP 客户端 SDK，负责 Agent 通信协议 |
| @ai-sdk/openai-compatible | ^2.0.47 | OpenAI 兼容 API 客户端（Vercel AI SDK） |
| ai | ^6.0.176 | Vercel AI SDK，streamText/generateText 驱动 API Agent |
| @modelcontextprotocol/sdk | ^1.29.0 | MCP SDK，负责与 Model Context Protocol 服务通信 |
| @ai-sdk/mcp | ^1.0.41 | AI SDK MCP 集成，将 MCP 工具转换为 AI SDK tools |
