...
const LANGUAGES: LangConfig[] = [
  ...
  },
  {
    ...
    wrappers: [
      ...
      },
      {
        ...
        prefix: "declare ",
        maxDepth: 0,
        createStandaloneLabel: "declare",
        createContainerWhenCovered: true,
      },
    ],
    nameOf: {
      fieldPriority: ["name", "source"],
  ...
  },
  {
    ...
    symbols: [
      ...
      {
        types: ["method_signature"],
        label: "method",
        hasName: true,
        labelByChild: { factory_constructor_signature: "factory" },
      },
      { types: ["getter_signature"], label: "getter", hasName: true },
      { types: ["setter_signature"], label: "setter", hasName: true },
      {
        types: ["constructor_signature", "constant_constructor_signature"],
        label: "constructor",
        hasName: true,
      },
