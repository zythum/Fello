...
export function Panel({ open, children, className }: PanelProps) {
  ...
  return (
    <>
      <div
        className={cn(
          "absolute bottom-0 left-0 right-0 top-11 flex flex-col border-t border-border -mt-px bg-background overflow-hidden transition-transform duration-300 ease-in-out",
