...
export function AgentTerminalOutput({
  ...
  return (
    <ScrollArea className="text-foreground/80" viewportClassName="max-h-[70vh]">
      <pre ref={containerRef} className="p-2 whitespace-pre-wrap font-mono text-[11px] leading-3.5">
